...
<tr>
          ...
          <td style="text-align:center">
               ...
               <a href="connection.php?enableuser=<?php echo $row['ID'];?>&username=<?php echo $row['username'];?>&password=<?php echo $row['password'];?>&email=<?php echo $row['email'];?>"
               class="btn btn-danger">Enable User</a>
