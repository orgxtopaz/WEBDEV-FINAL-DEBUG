...
<tr>
                    ...
                    <td style="text-align:center"> 
                    <a href="connection.php?editproduct=<?php echo $row['productId'];?>"
                    class="btn btn-info" >Update</a>

					</td>		

          <td style="text-align:center"> 
                    <a href="connection.php?archivedproduct=<?php echo $row['productId'];?>&archivedphoto=<?php echo $row['productPhoto'];?>&archivedname=<?php echo $row['productName'];?>&archivedbrand=<?php echo $row['productBrand'];?>&archivedDescription=<?php echo $row['productDescription'];?>&archivedPrice=<?php echo $row['productPrice'];?>&archivedstocks=<?php echo $row['stocks'];?>"
