...
<tr>
          ...
          <td style="text-align:center"> 
            <a href="connection.php?disableuser=<?php echo $row['ID'];?>&username=<?php echo $row['username'];?>&password=<?php echo $row['password'];?>&email=<?php echo $row['email'];?>"
               class="btn btn-info">Disable User</a>
              
					</td>		

          <td style="text-align:center"> 
            <a href="connection.php?addasadmin=<?php echo $row['ID'];?>&username=<?php echo $row['username'];?>&password=<?php echo $row['password'];?>"
               class="btn btn-success">as admin</a>
