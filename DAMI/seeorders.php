          ...
          <td>
              <style>   
                  .fa-recycle {
                    ...
                    <a href="connection.php?approved=<?php echo $row['productId'];?>&quantity=<?php echo $row['quantity'];?>&productPhoto=<?php echo $row['productPhoto'];?>&productName=<?php echo $row['productName'];?>&productBrand=<?php echo $row['productBrand'];?>&productDescription=<?php echo $row['productDescription'];?>&productPrice=<?php echo $row['productPrice'];?>&fullName=<?php echo $row['fullName'];?>&address=<?php echo $row['address'];?>&contactEmail=<?php echo $row['contactEmail'];?>&paymentMethod=<?php echo $row['paymentMethod'];?>&status=<?php echo $row['status'];?>&username=<?php echo $row['username'];?>"
